...
├── ddcci.nix              # DDC/CI monitor control
├── packages/
...
/dev/nvme0n1p2  LUKS encrypted, Btrfs:
  ...
  /persist/swap Swapfile (48GB, nocow)
```
...
To switch DEs, comment/uncomment the appropriate imports in `configuration.nix`:

```nix
imports = [
  ./de/gnome.nix    # Currently active
  #./de/kde.nix     # Uncomment for KDE
  #./de/cosmic.nix  # Uncomment for COSMIC
];
```
