# AUTOGENERATED by rc2nix - missing many settings afaict
{
  programs.plasma = {
    enable = true;
    shortcuts = {
      ActivityManager.switch-to-activity-62a51f83-7483-4825-a1fe-ef3647790a83 = [ ];
      ...
      kwin."KZones: Snap all windows" = "Ctrl+Alt+Space";
      ...
      kwin."KZones: Toggle zone overlay" = ["Alt" "Meta+Alt"];
      ...
      "services/org.kde.krunner.desktop"._launch = ["Alt+F2" "Search" "Alt+Space" "Meta+Space"];
    };
    configFile = {
      ...
      dolphinrc.General.ViewPropsTimestamp = "2025,12,13,15,17,13.334";
      dolphinrc."KFileDialog Settings"."Places Icons Auto-resize" = false;
      dolphinrc."KFileDialog Settings"."Places Icons Static Size" = 22;
      kactivitymanagerdrc.activities."62a51f83-7483-4825-a1fe-ef3647790a83" = "Default";
      kactivitymanagerdrc.main.currentActivity = "62a51f83-7483-4825-a1fe-ef3647790a83";
      ...
      kcminputrc."Libinput/1133/16534/Logitech ERGO M575".MiddleButtonEmulation = false;
      kcminputrc."Libinput/1133/16534/Logitech ERGO M575".PointerAcceleration = 0.000;
      kcminputrc."Libinput/1133/16534/Logitech ERGO M575".ScrollMethod = 0;
      kcminputrc."Libinput/2362/628/PIXA3854:00 093A:0274 Touchpad".ClickMethod = 2;
      kcminputrc."Libinput/2362/628/PIXA3854:00 093A:0274 Touchpad".LmrTapButtonMap = false;
      kcminputrc."Libinput/2362/628/PIXA3854:00 093A:0274 Touchpad".MiddleButtonEmulation = true;
      kcminputrc.Mouse.cursorSize = 28;
      kcminputrc.Mouse.cursorTheme = "Bibata-Modern-Ice";
      kded5rc.Module-device_automounter.autoload = false;
      kdeglobals.General.AccentColor = "255,219,82";
      kdeglobals.General.LastUsedCustomAccentColor = "255,219,82";
      ...
      kscreenlockerrc."Greeter/Wallpaper/org.kde.image/General".Image = "file:///nix/store/vsvlbrhb7cn965a46wdng83dk7sakzrl-plasma-workspace-wallpapers-6.5.3/share/wallpapers/DarkestHour/";
      kscreenlockerrc."Greeter/Wallpaper/org.kde.image/General".PreviewImage = "file:///nix/store/vsvlbrhb7cn965a46wdng83dk7sakzrl-plasma-workspace-wallpapers-6.5.3/share/wallpapers/DarkestHour/";
      kscreenlockerrc."Greeter/Wallpaper/org.kde.image/General".SlidePaths = "/nix/store/x6p8yrxfwqqz5lcinypm5l9ifbddwn7x-breeze-6.5.3/share/wallpapers/,/run/current-system/sw/share/wallpapers/";
      ksmserverrc.General.loginMode = "emptySession";
      ksplashrc.KSplash.Theme = "org.kde.breeze.desktop";
      kwalletrc.Wallet."First Use" = false;
      kwinrc.Desktops.Id_1 = "b347fd70-c7be-43ef-b5ad-1ca9f03944ac";
      kwinrc.Desktops.Id_2 = "5a6861e6-c5b8-420a-a0a5-14e5cab37146";
      kwinrc.Desktops.Number = 2;
      kwinrc.Desktops.Rows = 1;
      kwinrc.Effect-blur.BlurStrength = 2;
      kwinrc.Effect-blur.NoiseStrength = 1;
      kwinrc.Effect-kwin6_effect_aura_glow.RandomColor = true;
      kwinrc.Effect-overview.BorderActivate = 9;
      kwinrc.Effect-overview.GridBorderActivate = "1,7";
      kwinrc.Effect-windowview.BorderActivate = 4;
      ...
      kwinrc.Plugins.kwin6_effect_aura_glowEnabled = true;
      ...
      kwinrc.Script-kzones.enableZoneSelector = false;
      kwinrc.Script-kzones.layoutsJson = "[\n    {\n        \"name\": \"Default\",\n       \"padding\": 10,\n        \"zones\": [\n            {\n                \"x\": 0,\n                \"y\": 0,\n                \"height\": 100,\n                \"width\": 30\n            },\n            {\n                \"x\": 30,\n                \"y\": 0,\n                \"height\": 100,\n                \"width\": 40\n            },\n            {\n                \"x\": 70,\n                \"y\": 50,\n                \"height\": 50,\n                \"width\": 30\n            },\n            {\n                \"x\": 70,\n                \"y\": 0,\n                \"height\": 50,\n                \"width\": 30\n            }\n        ]\n    },\n    {\n        \"name\": \"Priority Grid\",\n        \"padding\": 10,\n        \"zones\": [\n            {\n                \"x\": 0,\n                \"y\": 0,\n                \"height\": 100,\n                \"width\": 25\n            },\n            {\n                \"x\": 25,\n                \"y\": 0,\n                \"height\": 100,\n                \"width\": 50\n            },\n            {\n                \"x\": 75,\n                \"y\": 0,\n                \"height\": 100,\n                \"width\": 25\n            }\n        ]\n    }\n]";
      kwinrc.Script-kzones.zoneOverlayHighlightTarget = 1;
      kwinrc.Script-kzones.zoneOverlayShowWhen = 1;
      kwinrc.Script-kzones.zoneSelectorTriggerDistance = 2;
      kwinrc.Tiling.padding = 6;
      kwinrc."Tiling/5a6861e6-c5b8-420a-a0a5-14e5cab37146/1e736dc1-b204-4f2d-9218-3eeac0425af5".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/5a6861e6-c5b8-420a-a0a5-14e5cab37146/46fdcae3-9b44-4669-aff4-c30e33e8e069".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc."Tiling/b347fd70-c7be-43ef-b5ad-1ca9f03944ac/1e736dc1-b204-4f2d-9218-3eeac0425af5".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.32929687500000093},{\"width\":0.39277343749999605},{\"layoutDirection\":\"vertical\",\"tiles\":[{\"height\":0.5104166666666685},{\"height\":0.4895833333333315}],\"width\":0.277929687500003}]}";
      kwinrc."Tiling/b347fd70-c7be-43ef-b5ad-1ca9f03944ac/46fdcae3-9b44-4669-aff4-c30e33e8e069".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      kwinrc."org.kde.kdecoration2".ButtonsOnRight = "HIFX";
      plasma-localerc.Formats.LANG = "en_US.UTF-8";
      plasmarc.Wallpapers.usersWallpapers = "/home/user/Pictures/1765433655647_wallhaven-968gwx.jpg";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-H-Splitter = "0,958,0";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-0-Splitter = 548;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-1-Splitter = 548;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-2-Splitter = 958;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-Splitter = 1003;
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0".Sizes = 958;
