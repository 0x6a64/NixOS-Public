{
  ...
  imports = [
    ...
    ./de-selector.nix # Desktop environment selector - set desktopEnvironment.active below
  ];
  ...
  # Ensure LUKS device is available in systemd initrd
  # boot.initrd.availableKernelModules = ["dm-crypt" "dm-mod"];
  ...
  # Enable "Silent boot" - TEMPORARILY DISABLED for LUKS debugging
  # boot.consoleLogLevel = 3;
  boot.initrd.verbose = true;  # Show detailed boot messages
  boot.kernelParams = [
    # "quiet"  # Disabled to see boot messages
    # "splash"  # Disabled to see boot messages
    "boot.shell_on_fail"
    # "udev.log_priority=3"  # Disabled for more logging
    "rd.systemd.show_status=true"  # Changed from auto to true
  ...
  # Set up hibernation with zram
  # Zram for active memory compression
  zramSwap = {
    enable = true;
    algorithm = "zstd";
  ...
  # Options: "gnome", "plasma", "cosmic"
  # The selector automatically imports the correct DE config and sets up integrations
  desktopEnvironment.active = "gnome";
