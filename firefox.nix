{
  ...
  isGnome = (osConfig.gearhead.desktop or null) == "gnome";
in {
  programs.firefox = {
    enable = true;
    ...
    policies = {
      ...
      # Keep toolbar customization available; layout is pinned via browser.uiCustomization.state below
    ...
    profiles.default = {
      ...
      settings = {
        ...
        "browser.uidensity" = 2; # Touch density (0 = normal, 1 = compact, 2 = touch)
        ...
        "browser.uiCustomization.state" = ''${builtins.toJSON {
            placements = {
              ...
              nav-bar = [
                ...
                "customizableui-special-spring10"
                "urlbar-container"
