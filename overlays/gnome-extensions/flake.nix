      ...
      gnomeExtensions =
        ...
        // {
          ...
          weather-oclock = prev.gnomeExtensions.weather-oclock.overrideAttrs {
            version = "24";
            src = prev.fetchzip {
              url = "https://extensions.gnome.org/extension-data/weatheroclockCleoMenezesJr.github.io.v24.shell-extension.zip";
              hash = "sha256-PmbLAlRMOvuRcq5EqOE8OZH6SV3HxxJzCf9OVjbhknA=";
              stripRoot = false;
            };
          };
          # caffeine: v60
