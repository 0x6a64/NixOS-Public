...
in
  with lib; {
    ...
    programs = {
      ...
      zsh = {
        ...
        shellAliases = {
          ...
          update = "sudo nix flake update && sudo nixos-rebuild boot --flake /home/user/Nixos --upgrade --option warn-dirty false";
    ...
    gtk.gtk4.theme = config.gtk.theme; # Silence stateVersion < 26.05 warning
